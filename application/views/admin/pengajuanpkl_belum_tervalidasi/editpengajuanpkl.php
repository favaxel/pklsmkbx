                ...
                <div class="container-fluid">
                    ...
                    <div class="card mb-3">
                        ...
                        <div class="card-header">
                            <a href="<?= base_url('admin/Pkl_Pengajuan_Belum_tervalidasi/') ?>"><i class="fas fa-arrow-left"></i> Kembali</a>
                        </div>
                        <div class="card-body">
...
<script type="text/javascript">
  ...
  footer: '<a class="btn btn-primary" href="<?= base_url('admin/Pkl_Pengajuan_Belum_tervalidasi/') ?>">kembali Ke Halaman Pengajuan PKL Belum Tervalidasi</a>'
