                ...
                <div class="container-fluid">
                    ...
                    <div class="card mb-3">
                        <div class="card-header">
                            <a href="<?= base_url('admin/Pkl_Proses_Pengajuan/') ?>"><i class="fas fa-arrow-left"></i> Kembali</a>
                        </div>
                        <div class="card-body">
                                    ...
                                    <?php
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td style="text-align:center">
                                                    <a href="<?= base_url('admin/Pkl_Proses_Pengajuan/editpengajuanpkl/' . $pelaksanaan->id_pengajuanpkl) ?>" class="btn btn-small"><i class="fas fa-edit"></i> Ubah</a>
                                                </td>
                                                <?php $i++ ?>
                                            </tr>
                                        <?php endforeach; ?>
