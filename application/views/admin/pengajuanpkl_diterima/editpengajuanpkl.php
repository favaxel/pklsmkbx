...
<body id="page-top" class="bg-prymary">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="card mb-3">
                        ...
                        <a  href="<?= base_url('admin/Pkl_Pengajuan_Diterima/listkelompokpkl/' . $pelaksanaanpkl->id_dudi) ?>"><i class="fas fa-arrow-left"></i> Kembali</a>
                        </div>
                        <div class="card-body">
...
<script>
  ...
  footer: '<a class="btn btn-primary" href="<?= base_url('admin/Pkl_Pengajuan_Diterima/listkelompokpkl/' . $pelaksanaanpkl->id_dudi) ?>">kembali Ke halaman Anggotak Kelompok PKL</a>'
