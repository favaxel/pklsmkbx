                ...
                <div class="container-fluid">
                    ...
                    <div class="card mb-3">
                        ...
                        <div class="card-body">
                            ...
                            <form action="<?= base_url('admin/DataGuru/tambahguru') ?>" method="post">
                                <div class="form-group">
                                    <label for="id_guru">Nis *</label>
                                    <input class="form-control <?php echo form_error('id_guru') ? 'is-invalid' : '' ?>" type="text" name="id_guru" placeholder="" />
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control <?php echo form_error('nama_guru') ? 'is-invalid' : '' ?>" type="text" name="nama_guru" placeholder="" />
                                    <div class="invalid-feedback">
